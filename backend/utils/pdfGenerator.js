...
y += GAP_Y;
  y = drawBox('Sexta Opción', generales.sexta_opcion, marginX, y);
y = drawBox('Septima Opción', generales.septima_opcion, marginX + 260, y);
y += GAP_Y;
  y = drawBox('Octava Opción', generales.octava_opcion, marginX, y);
y = drawBox('Novena Opción', generales.novena_opcion, marginX + 260, y);
y += GAP_Y;
